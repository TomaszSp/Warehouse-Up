...
{
    public partial class NaczBoxCreateForm : Form
    {
        public NaczBoxCreateForm()
        {
            InitializeComponent();
        }

        public static void NaczBoxCreateShow()
        {
            NaczBoxCreateForm dialog = new NaczBoxCreateForm();
            dialog.ShowDialog();
        }

        private void button1_Click(object sender, EventArgs e)
        {
            Insert("naczbox", "NUMER", textBox2.Text);
            Close();
        }
